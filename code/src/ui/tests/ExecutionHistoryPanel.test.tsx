...
describe("ExecutionHistoryPanel", () => {
  it("shows durable frozen history without Preview and corrects, retracts, and re-reports immutably", () => {
    ...
    const store = createReadyDayFrameTestStore(undefined, {
      allocateExecutionRecordId: () => `00000000-0000-4000-8000-${String(record++).padStart(12, "0")}` as ExecutionRecordId,
      allocateExecutionSubjectId: () => "00000000-0000-4000-8000-000000000100" as ExecutionSubjectId,
      executionHistoryClock: () => `2026-08-2${record}T12:00:00.000Z`,
    });
    const accepted = store.recordExecution({ subject: { kind: "unplanned" }, outcome: "completed",
      snapshot: { sourceFamily: "unplanned", title: "Archived activity", category: "optional",
